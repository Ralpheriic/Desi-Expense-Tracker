...
budgetForm.addEventListener('submit', function(event) {
    ...
    if (total > income / 2) {
        expenseMessage.textContent = "Kharche km krde bhai behen tu to ambani bhi ni hai";
    } else {
        expenseMessage.textContent = "Good job! You're spending wisely. why not treat yourself?";
    }
});
